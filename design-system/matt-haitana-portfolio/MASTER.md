...
**Project:** Matt Haitana Portfolio
**Generated:** 2026-06-30 00:30:13
...
|------|-----|--------------|
| Primary | `#2558E6` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#E9E6DE` | `--color-secondary` |
| Accent/CTA | `#2563EB` | `--color-accent` |
| Background | `#F6F4EE` | `--color-background` |
| Foreground | `#111214` | `--color-foreground` |
| Muted | `#EBE8E0` | `--color-muted` |
| Border | `#D4D0C7` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#18181B` | `--color-ring` |

**Color Notes:** Warm editorial neutral + disciplined cobalt accent. Dark mode uses near-black surfaces and a softened cobalt.
